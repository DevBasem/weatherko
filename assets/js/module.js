...
export const aqiText = {
  ...
  2: {
    level: "Fair",
    message:
      "Air quality is acceptable; however, there may be some pollutants that pose a moderate health concern for a very small number of people who are unusually sensitive to air pollution.",
  },
  3: {
    level: "Moderate",
    message:
